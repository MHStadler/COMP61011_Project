function [trainedModels, trainingResults, bestModel, testResult] = giniBreastTrainRoutine()
...
for i = 1:4
    ...
    model = decisionTree().withCalculator(giniImpurityCalculator).withMinCount(20).train(tr.data, tr.labels);
