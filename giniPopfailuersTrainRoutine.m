function [trainedModels, trainingResults, bestModel, testResult] = giniPopfailuersTrainRoutine()

load samplers;

[crossFold, test] = popFailureSampler.split(5, 5);
...
for i = 1:4
    ...
    model = decisionTree().withCalculator(giniImpurityCalculator()).withMinCount(5).train(tr.data, tr.labels);
