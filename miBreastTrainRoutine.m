function [trainedModels, trainingResults, bestModel, testResult] = miBreastTrainRoutine()
...
for i = 1:4
    ...
    model = decisionTree().withCalculator(mutualInformationCalculator()).withMinCount(20).train(tr.data, tr.labels);
